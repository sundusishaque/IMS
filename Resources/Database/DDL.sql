...
CREATE TABLE [Inventory_Management_System].[dbo].[store] (id int IDENTITY(1,1), name varchar(50), 
	location varchar(50), contact varchar(50) NOT NULL,  
	CONSTRAINT PK_store PRIMARY KEY(id));

CREATE TABLE [Inventory_Management_System].[dbo].[admin] (id int, name varchar(50), password varchar(50) NOT NULL, store_id int NOT NULL, 
	CONSTRAINT PK_admin PRIMARY KEY(id), 
	CONSTRAINT FK_admin_store FOREIGN KEY(store_id) REFERENCES store(id)); 

CREATE TABLE [Inventory_Management_System].[dbo].[employee] (id int IDENTITY(1,1), name varchar(50), contact varchar(50) NOT NULL, 
...
CREATE TABLE [Inventory_Management_System].[dbo].[customer] (id int IDENTITY(1,1), name varchar(50), contact varchar(50) NOT NULL, 
...
CREATE TABLE [Inventory_Management_System].[dbo].[inventory] (id int IDENTITY(1,1), name varchar(50), quantity int NOT NULL, 
...
CREATE TABLE [Inventory_Management_System].[dbo].[order_details] (id int IDENTITY(1,1), product_id int NOT NULL, name VARCHAR(50), 
...
CREATE TABLE [Inventory_Management_System].[dbo].[orders] (id int IDENTITY(1,1), order_id int NOT NULL,
